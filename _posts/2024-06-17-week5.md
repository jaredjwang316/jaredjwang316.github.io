...
This week, I reworked the task from last week. Then, I proceeded to the next task of converting all non-Maven bugs in Defects4J into Maven bugs. Some of the Defects4J projects are non-Maven, primarily Ant and Gradle projects. Converting these to Maven will enable me to run PITest (PIT) on the projects for mutation testing.
